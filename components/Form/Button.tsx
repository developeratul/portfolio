...
const colors = {
  ...
  secondary:
    "bg-secondary-600 dark:bg-secondary-500 text-gray-50 dark:text-gray-900 hover:bg-secondary-500 dark:hover:bg-secondary-400 active:bg-secondary-600 dark:active:bg-secondary-500 ring-secondary-500/40",
};
